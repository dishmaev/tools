...
targetDescription "Delete VM template type $COMMON_CONST_VBOX_VM_TYPE"
...
echoHelp $# 3 '<vmTemplate> [vmTemplateVersion=$COMMON_CONST_DEFAULT_VERSION] [resetCounter=$COMMON_CONST_FALSE]' \
    "$COMMON_CONST_DEBIANMINI_VM_TEMPLATE $COMMON_CONST_DEFAULT_VERSION $COMMON_CONST_FALSE" \
...
VAR_BOX_FILE_PATH=$ENV_DOWNLOAD_PATH/$COMMON_CONST_VBOX_VM_TYPE/$VAR_BOX_FILE_NAME
