...
VAR_RESULT=$($ENV_SCRIPT_DIR_NAME/take_${COMMON_CONST_VMWARE_VM_TYPE}_vm_snapshot.sh -y $VAR_VM_NAME $COMMON_CONST_SNAPSHOT_TEMPLATE_NAME $VAR_OVA_FILE_NAME $PRM_ESXI_HOST) || exitChildError "$VAR_RESULT"
