...
showDescription "Trigger for $COMMON_CONST_ORACLELINUX_VMTEMPLATE template VM"
...
echoHelp $# 3 '<ipAddressVM> [hostNameVM=$COMMON_CONST_ORACLELINUX_VMTEMPLATE] [osVersionVM=$COMMON_CONST_ORACLELINUX_VERSION]' "192.168.0.100 $COMMON_CONST_ORACLELINUX_VMTEMPLATE $COMMON_CONST_ORACLELINUX_VERSION" ""

###check commands

PRM_IPADDRESS=$1
PRM_HOSTNAME=${2:-$COMMON_CONST_ORACLELINUX_VMTEMPLATE}
PRM_OSVERSION=${3:-$COMMON_CONST_ORACLELINUX_VERSION}
