...
showDescription "Trigger for $COMMON_CONST_DEBIANMINI_VMTEMPLATE template VM"
...
echoHelp $# 2 '<ipAddressVM> [hostNameVM=$COMMON_CONST_DEBIANGUI_VMTYPE]' "192.168.0.100 $COMMON_CONST_DEBIANMINI_VMTYPE" ""
echoHelp $# 3 '<ipAddressVM> [hostNameVM=$COMMON_CONST_DEBIANMINI_VMTEMPLATE] [osVersionVM=$COMMON_CONST_DEBIANMINI_VERSION]' "192.168.0.100 $COMMON_CONST_DEBIANMINI_VMTEMPLATE $COMMON_CONST_DEBIANMINI_VERSION" ""

###check commands

PRM_IPADDRESS=$1
PRM_HOSTNAME=${2:-$COMMON_CONST_DEBIANMINI_VMTEMPLATE}
