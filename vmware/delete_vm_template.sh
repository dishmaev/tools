...
[ -r $COMMON_CONST_ESXI_DATA_PATH/${PRM_VMTEMPLATE}.cfg ]; then rm $COMMON_CONST_ESXI_DATA_PATH/${PRM_VMTEMPLATE}.cfg; fi; echo $COMMON_CONST_TRUE") || exitChildError "$VAR_RESULT"
