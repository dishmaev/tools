...
mkdir -m u=rwx,g=,o= /home/$COMMON_CONST_USER/.ssh; \
chown $COMMON_CONST_USER:$COMMON_CONST_USER /home/$COMMON_CONST_USER/.ssh; \
cp \$HOME/.ssh/authorized_keys /home/$COMMON_CONST_USER/.ssh/; \
chown $COMMON_CONST_USER /home/$COMMON_CONST_USER/.ssh/authorized_keys; \
chmod u=rw,g=,o= /home/$COMMON_CONST_USER/.ssh/authorized_keys"
if ! isRetValOK; then exitError; fi
$SSH_CLIENT root@$PRM_IPADDRESS "cat | pw mod user $COMMON_CONST_USER -h 0; chmod u+w /usr/local/etc/sudoers; \
