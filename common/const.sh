...
readonly COMMON_CONST_HISTORY_LOG="$COMMON_CONST_TRUE" #if true, save history all project action (create, build, deploy) in $ENV_PROJECT_HISTORY_PATH
...
readonly COMMON_CONST_TIME_FORMAT_LONG="$COMMON_CONST_FALSE" #if true, show elapsed time long version with year, month, day
