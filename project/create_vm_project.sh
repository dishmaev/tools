...
echoHelp $# 4 '<vmTemplate> [suitesPool=$COMMON_CONST_ALL] [vmRole=$COMMON_CONST_DEFAULT_VM_ROLE] [vmType=$COMMON_CONST_VMWARE_VM_TYPE]' \
"$COMMON_CONST_DEBIANMINI_VM_TEMPLATE '$COMMON_CONST_SUITES_POOL' $COMMON_CONST_DEFAULT_VM_ROLE $COMMON_CONST_VMWARE_VM_TYPE" \
...
if [ "$PRM_VM_ROLE" = "$COMMON_CONST_DEFAULT_VM_ROLE" ]; then
