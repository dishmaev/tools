...
echoHelp $# 4 '[vmTemplate=ENV_DEFAULT_VM_TEMPLATE] [suitesPool=$COMMON_CONST_ALL] [vmRolesPool=$COMMON_CONST_DEFAULT_VM_ROLE] [vmType=$ENV_INTERNAL_VM_TYPE]' \
...
PRM_VM_TYPE=${4:-$ENV_INTERNAL_VM_TYPE}
