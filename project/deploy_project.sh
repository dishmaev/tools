...
echoHelp $# 3 '[buildFile=$CONST_DEFAULT_BUILD_FILE] [suite=$COMMON_CONST_DEVELOP_SUITE] [vmRole=$COMMON_CONST_DEFAULT_VM_ROLE]' \
"$CONST_DEFAULT_BUILD_FILE $COMMON_CONST_DEVELOP_SUITE $COMMON_CONST_DEFAULT_VM_ROLE" \
"Available suites: $COMMON_CONST_SUITES_POOL"

###check commands

PRM_BUILD_FILE=${1:-$CONST_DEFAULT_BUILD_FILE}
